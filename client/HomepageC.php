...
<body>
<p>HELLO CLIENT <?php  echo $_SESSION['cName'] ?></p>
<p><a href="CMyprofile.php">My profile</a></p>
<p><a href="Workadd.php">My Works</a></p>
<p><a href="Requests.php">View Requests</a></p>
<p><a href="Rejected_list.php">Rejected Works</a> </p>
<p><a href="Accepted_list.php">Accepted Works</a> </p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">Get Your Work Done</h1>
                                ...
                                <!-- <a href="topics-detail.html"> -->
                                    <div class="d-flex">
                                        <div>
                                            ...
                                            <p class="mb-0">a person or organization using the services of a lawyer or other professional person or company.</p>
                                        </div>

                                        <!-- <span class="badge bg-design rounded-pill ms-auto">14</span> -->
                                    </div>

                                    <img src="../Asset/Templates/Main/images/6963167.jpg" class="custom-block-image img-fluid" alt="">
                                <!-- </a> -->
                            </div>
                        </div>
                            ...
                            <div class="custom-block custom-block-overlay">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="custom-block-overlay-text d-flex">
                                        <div>
                                            <h5 class="text-white mb-2">Freelancer</h5>

                                            <p class="text-white">Freelancer or freelance worker, are terms commonly used for a person who is self-employed and not necessarily committed to a particular employer long-term. Freelance workers are sometimes represented by a company or a temporary agency that resells freelance labor to clients.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-3 mb-lg- mb-md-0 ms-auto">
                            ...
                            <p>Bay St &amp;, Kolenchery, Ernakulam, pin-682310, India</p>
                            ...
                            <p class="d-flex align-items-center mb-1">
                                ...
                                <a href="tel: 7894567893" class="site-footer-link">
                                7894567893
                                </a>
                            </p>
                            ...
                            <p class="d-flex align-items-center">
                                ...
                                <a href="mailto:adithyanms175@gmail.com" class="site-footer-link">
                                    adithyanms@gmail.com
                                </a>
                            </p>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mx-auto">
                            ...
                            <p class="d-flex align-items-center mb-1">
                                ...
                                <a href="tel: 8075088482" class="site-footer-link">
                                8075088482
                                </a>
                            </p>
                            ...
                            <p class="d-flex align-items-center">
                                ...
                                <a href="mailto:adarshps@gmail.com" class="site-footer-link">
                                    adarshps@gmail.com
                                </a>
                            </p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <ul class="site-footer-links">
                            ...
                            <li class="site-footer-link-item">
                                <a href="Accepted_list.php" class="site-footer-link">My works</a>
                            </li>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4 mb-lg-0">
                        ...
                        <p class="text-white d-flex mb-1">
                            ...
                            <a href="tel:4561237891 " class="site-footer-link">
                            4561237891
                            </a>
                        </p>

                        <p class="text-white d-flex">
                            <a href="mailto:Pseudo@gmail.com" class="site-footer-link">
                                Pseudo@gmail.com
                            </a>
                        </p>
                    </div>
