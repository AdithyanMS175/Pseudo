...
$_SESSION['rid']=$_GET["rid"];
		$a = "update tbl_request set status='4', payment_date=curdate() where request_id='" .$_GET["rid"] . "'";
		if ($con->query($a)) {

?>
			<script>
				alert('Payment Completed');
				window.location = "Paybill.php?id=<?php echo $_GET['rid'] ?>";
			</script>
<?php
		} else {
	...
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				...
				<div class="input-box">
					<input class="name" type="text" name="txtedate" id="txtdate" data-mask="00 / 00" placeholder="EXPIRY DATE" required>
					<i class="fa fa-calendar icon" aria-hidden="true"></i>
				</div>
			</div>
			<div class="input-group">
				<div class="input-box">
					<input type="checkbox" name="chk_box" id="chk_box" required />I Agree to all <a href="Termsandconditions.php">Terms and conditions</a>
				</div>
