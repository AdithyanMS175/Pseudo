...
$sel = "select * from tbl_freelan where freelan_id='" . $_GET["id"] . "'";
$res = $con->query($sel);
$row = $res->fetch_assoc();
?>
<!DOCTYPE html>
        ...
        <div class="chat-inner">
            ...
            <div class="chat-nav">
                ...
                <div class="nav-end">
                    ...
                    <a href="Accepted_list.php" class="chat-nav-item is-icon is-hidden-mobile">
                ...
                <div class="chat-action">
                    <div class="chat-action-inner">
                        <div class="control" style="text-align: center">
                            ...
                            <input type="button" value="Send" name="btn_send" id="btn_send" onclick="sendChat(<?php echo $_GET['id'] ?>)" style="border: none;background-color: #5082c3;border-radius: 15px 10px; color: white;
