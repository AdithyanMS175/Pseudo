  ...
  <body class="g-sidenav-show  bg-gray-200">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link text-white active bg-gradient-primary" href="HomepageA.php">
              ...
              <ul class="nav ms-4">
                <li class="nav-item">
                  <a class="nav-link text-white" href="UnFreelan.php">
                    ...
                    <span class="sidenav-normal">Rejected Freelancers </span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="UnClient.php">
                    ...
                    <span class="sidenav-normal">Rejected Clients </span>
                  </a>
                </li>
              </ul>
            </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../Asset/Templates/Admin/assets/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                      </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../Asset/Templates/Admin/assets/img/small-logos/logo-spotify.svg"
      ...
      <!-- End Navbar -->
      <?php
      $result = "select count(work_id) as total from tbl_work";
      $total = $con->query($result);
            ...
            <div class="card">
              <div class="card-header p-3 pt-2">
                ...
                <div class="icon icon-lg icon-shape bg-gradient-dark shadow-dark text-center border-radius-xl mt-n4 position-absolute">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" background-position="center" height="60" fill="white" class="bi bi-file-earmark-code" viewBox="0 0 16 16">
                ...
                <div class="text-end pt-1">
                  <p class="text-sm mb-0 text-capitalize">Ongoing Works</p>
                  <h4 class="mb-0"><?php echo $data['total'] ?></h4>
                </div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
              <div class="card-header p-3 pt-2">
                ...
                <?php
                $result = "select count(freelan_id) as total_freelan from tbl_freelan";
                $total = $con->query($result);
                $data = $total->fetch_assoc();
                ...
                <div class="text-end pt-1">
                  <p class="text-sm mb-0 text-capitalize">Total Freelan</p>
                  <h4 class="mb-0"><?php echo $data['total_freelan'] ?></h4>
                </div>
              </div>
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
          ...
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
              <div class="card-header p-3 pt-2">
                ...
                <?php
                $result = "select count(client_id) as total_client from tbl_client";
                $total = $con->query($result);
                $data = $total->fetch_assoc();
                ...
                <div class="text-end pt-1">
                  ...
                  <h4 class="mb-0"><?php echo $data['total_client'] ?></h4>
                </div>
              </div>
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
            ...
            <div class="card">
              <div class="card-header p-3 pt-2">
                <div class="icon icon-lg icon-shape bg-gradient-info shadow-info text-center border-radius-xl mt-n4 position-absolute">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="" fill="white" class="bi bi-bug-fill" viewBox="0 0 16 16">
                    <path d="M4.978.855a.5.5 0 1 0-.956.29l.41 1.352A5 5 0 0 0 3 6h10a5 5 0 0 0-1.432-3.503l.41-1.352a.5.5 0 1 0-.956-.29l-.291.956A5 5 0 0 0 8 1a5 5 0 0 0-2.731.811l-.29-.956z" />
                    <path d="M13 6v1H8.5v8.975A5 5 0 0 0 13 11h.5a.5.5 0 0 1 .5.5v.5a.5.5 0 1 0 1 0v-.5a1.5 1.5 0 0 0-1.5-1.5H13V9h1.5a.5.5 0 0 0 0-1H13V7h.5A1.5 1.5 0 0 0 15 5.5V5a.5.5 0 0 0-1 0v.5a.5.5 0 0 1-.5.5zm-5.5 9.975V7H3V6h-.5a.5.5 0 0 1-.5-.5V5a.5.5 0 0 0-1 0v.5A1.5 1.5 0 0 0 2.5 7H3v1H1.5a.5.5 0 0 0 0 1H3v1h-.5A1.5 1.5 0 0 0 1 11.5v.5a.5.5 0 1 0 1 0v-.5a.5.5 0 0 1 .5-.5H3a5 5 0 0 0 4.5 4.975" />
                  </svg>
                </div>
                <?php
                $result = "select count(complaint_id) as total_complaint from tbl_complaint";
                $total = $con->query($result);
                $data = $total->fetch_assoc();
                ...
                <div class="text-end pt-1">
                  ...
                  <h4 class="mb-0"><?php echo $data['total_complaint'] ?></h4>
                </div>
              </div>
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
                ...
                <div class="row">
                  <div class="col-lg-6 col-7">
                    ...
                    <p class="text-sm mb-0">
                      ...
                      <span class="font-weight-bold ms-1"><?php echo $data['total'] ?> done</span> this month
                    </p>
                  </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Work name
                        </th>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex px-2 py-1">
                              <div>
                                <img src="../Asset/Files/Freelan/Photo/<?php echo $data['freelan_photo'] ?>" class="avatar avatar-sm me-3" alt="xd">
                              </div>
                              <div class="d-flex flex-column justify-content-center">
                          ...
                          <div class="progress-wrapper w-75 mx-auto">
                            <div class="progress-info">
                              <div class="progress-percentage">
                                <span class="text-xs font-weight-bold"><?php echo $data['status'] ?></span>
                              </div>
                            </div>
                            <div class="progress">
    ...
    <script src="../Asset/Templates/Admin/assets/js/material-dashboard.min.js?v=3.0.0"></script>
  </body>
