...
<p><a href="Viewworks.php">Works</a></p>
...
<body id="top">
    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="HomepageU.php">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="HomepageU.php">Home</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="SearchWorks.php">Browse Works</a>
                        </li>
                    ...
                    <div class="d-none d-lg-block">
                        ...
                        <a href="Myprofile.php"><img src="../Asset/Files/Freelan/Photo/<?php echo $_SESSION['fph'] ?>" height="50" width="50" style="border-radius:50%;object-fit:cover;" />&nbsp;<?php echo $_SESSION['FName'] ?></a>
                        &nbsp;&nbsp;&nbsp;
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h1 class="text-white text-center">Learn. Work. Enjoy</h1>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                        <div class="custom-block bg-white shadow-lg">
                            <a href="SearchWorks.php">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="mb-2">Freelance</h5>

                                        <p class="mb-0">Freelance (sometimes spelled free-lance or free lance),freelancer, or freelance worker, are terms commonly used for a person who is self-employed and not necessarily committed to a particular employer long-term. Freelance workers are sometimes represented by a company or a temporary agency that resells freelance labor to clients; others work independently or use professional associations or websites to get work.</p>
                                    </div>

                                    <!-- <span class="badge bg-design rounded-pill ms-auto">14</span> -->
                                </div>

                                <img src="../Asset/Templates/Main/images/Thumbnail_-_Freelance_Course.jpeg" style="border-radius:10%; object-fit:cover;" class="custom-block-image img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-block custom-block-overlay">
                            <div class="d-flex flex-column h-100">
                                <img src="../Asset/Templates/Main/images/businesswoman-using-tablet-analysis.jpg" class="custom-block-image img-fluid" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-3 mb-lg- mb-md-0 ms-auto">
                        ...
                        <p class="d-flex align-items-center mb-1">
                            ...
                            <a href="tel: 4561234567" class="site-footer-link">
                                4561234567
                            </a>
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <ul class="site-footer-links">
                        ...
                        <li class="site-footer-link-item">
                            <a href="Myworks.php" class="site-footer-link">My works</a>
                        </li>

                        <li class="site-footer-link-item">
                                <a href="Myprofile.php" class="site-footer-link">My Profile</a>
                            </li>
